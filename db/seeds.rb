...
user2 = User.create!(:first_name => "Mac", :last_name => "Roni", :email => "yes@no.com", :age => 40, :location => "Seattle", :password => "123456")
...
user5 = User.create!(:first_name => "Doom", :last_name => "Pling", :email => "hargow@soy.com", :age => 25, :location => "New Orleans", :password => "teatime")
user6 = User.create!(:first_name => "Av", :last_name => "Cado", :email => "acado@keto.com", :age => 15, :location => "Las Vegas", :password => "cadocado")
user7 = User.create!(:first_name => "Sash", :last_name => "Imi", :email => "toro@yum.com", :age => 28, :location => "Dallas", :password => "yumyum21")
...
business9 = Business.create!(:name => "Kenzo Sushi", :website => "https://www.kenzosushisanjose.com/", :category => "Japanese", :address => "5465 Snell Ave", :city => "San Jose", :state => "CA", :zip_code => 95123, :phone_number => "(408) 226-2114", :hours => "11:30 AM - 8:15 PM", :lat => 37.25449341305017, :lng => -121.83108702901548)
business10 = Business.create!(:name => "Jang Su Jang", :website => "http://jangsujang.com/santa-clara/", :category => "Korean", :address => "3561 El Camino Real Ste 10", :city => "Santa Clara", :state => "CA", :zip_code => 95051, :phone_number => "(408) 246-1212", :hours => "11:00 AM - 9:00 PM", :lat => 37.35376522070469, :lng => -121.99454923692473)
business11 = Business.create!(:name => "Koi Palace", :website => "https://koipalace.com/milpitas-ca", :category => "Chinese", :address => "768 Barber Ln", :city => "Santa Clara", :state => "CA", :zip_code => 95035, :phone_number => "(408) 432-8833", :hours => "11:00 AM - 2:30 PM", :lat => 37.419490026337776, :lng => -121.9156473866544) 
business12 = Business.create!(:name => "House of Thai", :website => "houseofthaisf.com", :category => "Thai", :address => "901 Larkin St", :city => "San Francisco", :state => "CA", :zip_code => 94109, :phone_number => "(415) 441-2248", :hours => "11:00 AM - 10:00 PM", :lat => 37.786324774832956, :lng => -122.4185314210328)
business13 = Business.create!(:name => "Boba Guys", :website => "bobaguys.com", :category => "Coffee & Tea", :address => "429 Stockton St", :city => "San Francisco", :state => "CA", :zip_code => 94108, :phone_number => "(415) 967-2622", :hours => "11:00 AM - 5:00 PM", :lat => 37.79000337975663, :lng => -122.4073974615103)
business14 = Business.create!(:name => "Teaspoon", :website => "teaspoonlife.com", :category => "Coffee & Tea", :address => "2125 Polk St", :city => "San Francisco", :state => "CA", :zip_code => 94109, :phone_number => "(415) 872-9245", :hours => "11:00 AM - 9:00 PM", :lat => 37.7963392912213, :lng => -122.42225576153862)
business15 = Business.create!(:name => "Gen Korean BBQ", :website => "gendelivers.com", :category => "Korean", :address => "1628 Hostetter Rd Ste F", :city => "San Jose", :state => "CA", :zip_code => 95131, :phone_number => "(408) 477-2773", :hours => "11:00 AM - 10:00 PM", :lat => 37.387426925622364, :lng => -121.88509645414914)
business16 = Business.create!(:name => "Gombei", :website => "qpotsanjose.com", :category => "Japanese", :address => "193 Jackson St", :city => "San Jose", :state => "CA", :zip_code => 95112, :phone_number => "(408) 279-4311", :hours => "4:30 PM - 7:00 PM", :lat => 37.34892820879268, :lng => -121.89498770572658)
business17 = Business.create!(:name => "QPOT", :website => "qpotsanjose.com", :category => "Chinese", :address => "1610 E Capitol Expy", :city => "San Jose", :state => "CA", :zip_code => 95121, :phone_number => "(669) 234-3095", :hours => "11:00 AM - 10:00 PM", :lat => 37.30590638767442, :lng => -121.811951105359)
business18 = Business.create!(:name => "Dumpling Kitchen", :website => "dumplingkitchenca.com", :category => "Chinese", :address => "1935 Taraval St", :city => "San Francisco", :state => "CA", :zip_code => 94116, :phone_number => "(415) 682-8938", :hours => "11:00 AM - 9:00 PM", :lat => 37.74234826382537, :lng => -122.48706985969028)
business19 = Business.create!(:name => "Soyful Desserts", :website => "https://zmenu.com/soyful-desserts-san-jose-2-online-menu/", :category => "Coffee & Tea", :address => "999 Story Rd Unit 9048", :city => "San Jose", :state => "CA", :zip_code => 95122, :phone_number => "(408) 216-9026", :hours => "12:00 PM - 10:00 PM", :lat => 37.3320671798462, :lng => -121.85706311921996)
business20 = Business.create!(:name => "A Bellagio Italian Restaurant", :website => "abellagio.com", :category => "Italian", :address => "33 S Central Ave", :city => "Campbell", :state => "CA", :zip_code => 95008, :phone_number => "(408) 370-7705", :hours => "5:00 PM - 9:00 PM", :lat => 37.28653989970948, :lng => -121.94410600572799)
business21 = Business.create!(:name => "Maggiano's Little Italy", :website => "locations.maggianos.com", :category => "Italian", :address => "3055 Olin Ave Ste 1000", :city => "San Jose", :state => "CA", :zip_code => 95128, :phone_number => "(408) 423-8973", :hours => "11:00 AM - 10:00 PM", :lat => 37.32075052268578, :lng =>  -121.94967174435664)
...
review15 = Review.create!(:content => "Definitely would come back. Yuuuuuum.", :rating => 5, :author_id => 1, :business_id => 10)
review16 = Review.create!(:content => "Food was good, but the service was really slow. Meh.", :rating => 2, :author_id => 2, :business_id => 11)
review17 = Review.create!(:content => "Love the atmosphere. Definitely feels welcoming and service was great", :rating => 4, :author_id => 7, :business_id => 12)
review18 = Review.create!(:content => "I only got takeout, so can't say much about the ambiance or service, but food was good!", :rating => 4, :author_id => 7, :business_id => 13)
review19 = Review.create!(:content => "Gave me some stomach problems. Be warned", :rating => 2, :author_id => 3, :business_id => 14)
review20 = Review.create!(:content => "Atmosphere kinda reminds me of fast food, but the food quality was great!", :rating => 3, :author_id => 4, :business_id => 15)
review21 = Review.create!(:content => "AYCE is always worth the money. Come with an empty stomach!", :rating => 4, :author_id => 4, :business_id => 16)
review22 = Review.create!(:content => "Kind of small and definitely crowded on some days, but the soup dumplings are worth the wait!", :rating => 4, :author_id => 5, :business_id => 17)
review23 = Review.create!(:content => "Service was poor and space was cramped. Food was good, but felt super rushed to leave the table.", :rating => 2, :author_id => 7, :business_id => 17)
review24 = Review.create!(:content => "Sad the convetors aren't working yet because of Covid, but the food is amazing and love that you get your own personal hot pot base.", :rating => 4, :author_id => 3, :business_id => 5)
review25 = Review.create!(:content => "Definitely order over the phone for pickup. They always seem to be busy. I recommend the pad see ew!", :rating => 3, :author_id => 1, :business_id => 3)
review26 = Review.create!(:content => "Pasta was good. Needs more sauce though!", :rating => 3, :author_id => 7, :business_id => 21)
review27 = Review.create!(:content => "Yum! So good! Worth the wait. You should reserve!!", :rating => 5, :author_id => 6, :business_id => 20)
review28 = Review.create!(:content => "Never a bad time to get desserts!", :rating => 5, :author_id => 4, :business_id => 19)
review28 = Review.create!(:content => "Really long wait. :(", :rating => 1, :author_id => 1, :business_id => 19)
review29 = Review.create!(:content => "Noodles were bomb!", :rating => 4, :author_id => 3, :business_id => 18)
review29 = Review.create!(:content => "Noodles were bomb!", :rating => 4, :author_id => 3, :business_id => 18)
review30 = Review.create!(:content => "Worst service I have ever received in my life! They forgot so many items!", :rating => 1, :author_id => 7, :business_id => 15)

reviewTag1 = ReviewTag.create(:author_id => 2, :review_id => 10, :useful => true, :funny => false, :cool => true)
reviewTag2 = ReviewTag.create(:author_id => 5, :review_id => 1, :useful => true, :funny => true, :cool => false)
reviewTag3 = ReviewTag.create(:author_id => 3, :review_id => 3, :useful => true, :funny => false, :cool => false)
reviewTag4 = ReviewTag.create(:author_id => 4, :review_id => 15, :useful => false, :funny => true, :cool => true)
reviewTag5 = ReviewTag.create(:author_id => 5, :review_id => 17, :useful => false, :funny => false, :cool => true)
reviewTag6 = ReviewTag.create(:author_id => 1, :review_id => 18, :useful => false, :funny => false, :cool => true)
reviewTag7 = ReviewTag.create(:author_id => 2, :review_id => 19, :useful => false, :funny => true, :cool => false)
reviewTag8 = ReviewTag.create(:author_id => 6, :review_id => 2, :useful => true, :funny => true, :cool => true)
reviewTag9 = ReviewTag.create(:author_id => 7, :review_id => 3, :useful => false, :funny => false, :cool => true)
reviewTag10 = ReviewTag.create(:author_id => 7, :review_id => 4, :useful => true, :funny => true, :cool => false)
...
bizIndex9 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/kenzo/kenzo_1.jpeg")
bizIndex10 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/jang_su_jang/jang_su_2.jpeg")
bizIndex11 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/koi_palace/kp_1.jpeg")
bizIndex12 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/house_of_thai/1.jpg")
bizIndex13 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/boba_guys/bg_1.jpeg")
...
bizIndex16 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/gombei/o+(3).jpg")
bizIndex17 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/qpot/o+(1).jpg")
bizIndex18 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/dumpling_kitchen/o+(1).jpg")
bizIndex19 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/soyful/o+(1).jpg")
bizIndex20 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/abellagio/o+(1).jpg")
bizIndex21 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/maggianos/o+(1).jpg")
...
# Jang Su Jang
jsj1 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/jang_su_jang/jang_su_1.jpeg")
jsj2 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/jang_su_jang/jang_su_3.jpeg")
jsj3 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/jang_su_jang/jang_su_4.jpeg")
jsj4 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/jang_su_jang/jang_su_5.jpeg")
...
# House of Thai
houseThai1 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/house_of_thai/papayaSalad.jpg")
houseThai2 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/house_of_thai/shukiyakiNoodles.jpg")
houseThai3 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/house_of_thai/tomKha.jpg")
houseThai4 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/house_of_thai/veggieEggrolls.jpg")
...
# Boba Guys
bobaguy1 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/boba_guys/bg_2.jpeg")
bobaguy2 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/boba_guys/bg_3.jpeg")
bobaguy3 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/boba_guys/bg_4.jpeg")
bobaguy4 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/boba_guys/bg_5.jpeg")
...
# Dumpling Kitchen
dk1 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/dumpling_kitchen/o+(2).jpg")
dk2 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/dumpling_kitchen/o+(3).jpg")
dk3 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/dumpling_kitchen/o+(5).jpg")
dk4 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/dumpling_kitchen/o.jpg")
