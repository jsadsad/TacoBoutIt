...
business8 = Business.create!(:name => "Ding Tea", :website => "http://www.dingtea.club", :category => "Coffee & Tea", :address => "8280 Mira Mesa Ste C", :city => "San Diego", :state => "CA", :zip_code => 92126, :phone_number => "(503) 234-7786", :hours => "11:00 AM - 10:00 PM", :lat => 32.91477967186302, :lng => -117.14616578152645)
...
review10 = Review.create!(:content => "Great drinks! Boba latte is my favorite.", :rating => 4, :author_id => 3, :business_id => 8)
review11 = Review.create!(:content => "Good burgers. Good for lunch.", :rating => 4, :author_id => 1, :business_id => 7)
review12 = Review.create!(:content => "Great place to go on a Friday night. Worth the wait!", :rating => 5, :author_id => 5, :business_id => 6)
review13 = Review.create!(:content => "Yum yum yum :)", :rating => 4, :author_id => 2, :business_id => 8)
review14 = Review.create!(:content => "Never a bad place to eat.", :rating => 5, :author_id => 5, :business_id => 7)
...
# Sushi Sam
sushiSam1 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/SushiSam/SS_2.jpg")
sushiSam2 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/SushiSam/SS_3.jpg")
sushiSam3 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/SushiSam/SS_4.jpg")
sushiSam4 = open("https://tbi-seeds.s3-us-west-1.amazonaws.com/SushiSam/SS_5.jpg")
